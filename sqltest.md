...
SELECT * FROM CSQ_1 WHERE COL1 NOT IN (SELECT AVG(CSQ_2.COL2) FROM CSQ_2 WHERE CSQ_2.ID IN (SELECT CSQ_3.ID FROM CSQ_3 WHERE CSQ_1.ID = CSQ_3.ID));


SELECT CSQ_3.ID FROM CSQ_3,CSQ_2 WHERE CSQ_2.ID > CSQ_3.ID;

SELECT AVG(CSQ_2.FEAT2) FROM CSQ_2 WHERE CSQ_2.ID IN (SELECT CSQ_3.ID FROM CSQ_3 WHERE CSQ_1.ID > CSQ_3.ID);
...
SELECT * FROM CSQ_3 WHERE CSQ_1.ID < CSQ_3.ID;
