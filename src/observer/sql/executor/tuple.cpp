...
void TupleSchema::add_projection(AttrType type, const char* table_name,
                                 const char* field_name) {
  fields_.emplace_back(type, table_name, field_name, true);
}

bool TupleSchema::add_if_not_exists(AttrType type, const char* table_name,
                                    const char* field_name,
                                    bool is_projection) {
...
void TupleSet::remove(int index) { tuples_.erase(tuples_.begin() + index); }
